...
import os
os.environ['GROQ_API_KEY']="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"
...
translation_task = Task(
    description='Translate the summary to Bengali',
    expected_output="Bengali translation of the hook documentation",
    agent=translator,
